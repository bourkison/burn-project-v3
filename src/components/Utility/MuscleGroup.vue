<template>
    ...
    <div class="muscle-groups" align="center">
        ...
        >
            ...
            <g id="Back-Muscles">
                <g>
                    <g id="Trapezius" ref="Trapezius">
                        <path
                            @click="bodyPartClickHandler"
                            @mouseover="hoverHandler(true, 'Trapezius')"
                    ...
                    <g id="Lats" ref="Lats">
                        <path
                            @click="bodyPartClickHandler"
                            @mouseover="hoverHandler(true, 'Lats')"
                            @mouseleave="hoverHandler(false)"
                    ...
                    <g id="Triceps" ref="Triceps">
                        <path
                            @click="bodyPartClickHandler"
                            @mouseover="hoverHandler(true, 'Triceps')"
                            @mouseleave="hoverHandler(false)"
                    ...
                    <g id="Forearms" ref="Forearms">
                        <path
                            @click="bodyPartClickHandler"
                            @mouseover="hoverHandler(true, 'Forearms')"
                            @mouseleave="hoverHandler(false)"
                    ...
                    <g id="Glutes" ref="Glutes">
                        <path
                            @click="bodyPartClickHandler"
                            @mouseover="hoverHandler(true, 'Glutes')"
                            @mouseleave="hoverHandler(false)"
                    ...
                    <g id="Hamstrings" ref="Hamstrings">
                        <path
                            @click="bodyPartClickHandler"
                            @mouseover="hoverHandler(true, 'Hamstrings')"
                            @mouseleave="hoverHandler(false)"
                    ...
                    <g id="Calves" ref="Calves">
                        <path
                            @click="bodyPartClickHandler"
                            @mouseover="hoverHandler(true, 'Calves')"
                            @mouseleave="hoverHandler(false)"
            ...
            <g id="Front-Muscles" ref="Front-Muscles">
                <g id="Deltoids" ref="Deltoids">
                    <path
                        @click="bodyPartClickHandler"
                        @mouseover="hoverHandler(true, 'Deltoids')"
                        @mouseleave="hoverHandler(false)"
                ...
                <g id="Biceps" ref="Biceps">
                    <path
                        @click="bodyPartClickHandler"
                        @mouseover="hoverHandler(true, 'Biceps')"
                        @mouseleave="hoverHandler(false)"
                ...
                <g id="Pectorals" ref="Pectorals">
                    <path
                        @click="bodyPartClickHandler"
                        @mouseover="hoverHandler(true, 'Pectorals')"
                        @mouseleave="hoverHandler(false)"
                ...
                <g id="Obliques" ref="Obliques">
                    <path
                        @click="bodyPartClickHandler"
                        @mouseover="hoverHandler(true, 'Obliques')"
                        @mouseleave="hoverHandler(false)"
                ...
                <g id="Abs" ref="Abs">
                    <path
                        @click="bodyPartClickHandler"
                        @mouseover="hoverHandler(true, 'Abs')"
                        @mouseleave="hoverHandler(false)"
                ...
                <g id="Quads" ref="Quads">
                    <path
                        @click="bodyPartClickHandler"
                        @mouseover="hoverHandler(true, 'Quads')"
                        @mouseleave="hoverHandler(false)"
                ...
                <g id="Adductors" ref="Adductors">
                    <path
                        @click="bodyPartClickHandler"
                        @mouseover="hoverHandler(true, 'Adductors')"
                        @mouseleave="hoverHandler(false)"
