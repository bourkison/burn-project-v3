...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"burn-project-v3","htmlAttrs":{"lang":"en"},"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_5ac3816e === 'function') {
    await nuxt_plugin_plugin_5ac3816e(app.context, inject)
  }
  ...
  if (typeof nuxt_plugin_observeVisibility_547a765f === 'function') {
    await nuxt_plugin_observeVisibility_547a765f(app.context, inject)
  }
